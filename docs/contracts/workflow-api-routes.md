# Workflow API Route Contract (Compatibility Pointer)
...
- Current pointer verification date: `2026-02-27`.
- Current runtime route total: `45`.
- Do not add route or schema details in this compatibility file; keep all normative updates in the canonical contract.
